...
import { be, ca, cs, de, en, es, eu, fi, fr, gl, hr, it, nb, nl, pl, pt, tr, sk, sv, srLatn, ro, ru, zhHans  } from 'vuetify/es5/locale'
...
export default ({ res, nuxtState }) => {
  ...
  return {
    lang: { locales: { be, ca, cs, de, en, es, eu, fi, fr, gl, hr, it, nb, nl, pl, pt, sk, srLatn, sv, tr, ro, ru, zhHans } },
    theme: {
      options: {
