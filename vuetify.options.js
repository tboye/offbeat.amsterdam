...
import { be, ca, cs, de, en, es, eu, fi, fr, gl, hr, it, nb, nl, pl, pt, tr, sl, sk, sv, srLatn, srCyrl, ro, ru, zhHans  } from 'vuetify/es5/locale'
...
export default ({ res, nuxtState }) => {
  ...
  return {
    lang: { locales: { be, ca, cs, de, en, es, eu, fi, fr, gl, hr, it, nb, nl, pl, pt, sl, sk, srLatn, srCyrl, sv, tr, ro, ru, zhHans } },
    theme: {
      options: {
